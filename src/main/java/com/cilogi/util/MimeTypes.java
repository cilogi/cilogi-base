...
//
// File:        MimeTypes.java  (11-Apr-2011)
// Author:      tim
// $Id$
//
...
public class MimeTypes {
    ...
    public static final String MIME_APPLICATION_X_FONT_WOFF = "application/x-font-woff";

    public static final String MIME_CACHE_MANIFEST = "text/cache-manifest";
    ...
    public static final String MIME_FONT_EOT = "application/vnd.ms-fontobject";
    public static final String MIME_FONT_TTF = "application/x-font-ttf";

    private static final Set<String> IMAGE_MIMES = Sets.newHashSet(
        MIME_IMAGE_BMP, MIME_IMAGE_GIF, MIME_IMAGE_X_ICON,
        ...
        mimeTypeMapping = new HashMap<String, String>(200) {
            private void put1(String key, String value) {
                if (put(key, value) != null) {
                    LOG.error("Mime type " + key + " is duplicated, which is an error");
...

            {
                ...
                put("eot", MIME_FONT_EOT);
                put("ttf", MIME_FONT_TTF);
            }};
    }
